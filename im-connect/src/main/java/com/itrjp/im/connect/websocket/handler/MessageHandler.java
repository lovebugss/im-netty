...
public class MessageHandler extends SimpleChannelInboundHandler<Packet.Data> {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, Packet.Data msg) throws Exception {
